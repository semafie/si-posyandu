                      ...
                      <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                         ...
                         <div class="dua_input">
                              ...
                              <input class="form-control" type="text" placeholder="Masukkan nama" id="nama" value="{{ $item->nama_user }}" name="name" />
                          </div>
                            <div class="dua_label">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
     ...
     <div class="dua_input">
          ...
          <input class="form-control" type="text" placeholder="Masukkan nama" id="nama" value="" name="name" />
      </div>
        <div class="dua_label">
          <label for="alamat" class="form-label">alamat</label>
          <label for="jenis_kelamin"  class="form-label">jenis_kelamin</label>
